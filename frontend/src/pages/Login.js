    ...
    <div style={styles.page}>
      <div style={styles.card}>
        <div style={styles.header}>
          ...
          <p style={styles.tagline}>Discover your city, personalized for your vibe.</p>
        </div>

        <h2 style={styles.title}>Member Login</h2>
        <p style={styles.sub}>Welcome back to VibeMap.</p>
        ...
        <p style={styles.footer}>
          Not a member?{' '}
          <Link to="/register" style={styles.link}>Join VibeMap</Link>
        </p>
      </div>
    </div>
  );
